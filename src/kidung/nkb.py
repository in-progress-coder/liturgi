...
TARGET_PAGE = "https://www.gkiharapanindah.org/download/rekap-nyanyikanlah-kidung-baru/"
PATTERN_PREFIX = "https://www.gkiharapanindah.org/nyanyian-jemaat/nyanyikanlah-kidung-baru/nkb"
...
FALLBACK_ENDPOINTS = [
    ...
    "https://www.gkiharapanindah.org/category/nyanyian-jemaat/nyanyikanlah-kidung-baru/",
    "https://www.gkiharapanindah.org/category/nyanyian-jemaat/nyanyikanlah-kidung-baru/feed/",
]
...
def extract_matching_links_from_html(html: str, base_url: str = "") -> List[str]:
    ...
    rx = re.compile(r"https://www\.gkiharapanindah\.org/nyanyian-jemaat/nyanyikanlah-kidung-baru/nkb[^\s\"'<)]+", re.I)
...
def main():
    ...
    with open("nkb_links.txt", "w", encoding="utf-8") as f:
        f.write("\n".join(links))
    with open("nkb_links.json", "w", encoding="utf-8") as f:
