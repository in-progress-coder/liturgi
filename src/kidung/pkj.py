...
TARGET_PAGE = "https://www.gkiharapanindah.org/download/rekap-pelengkap-kidung-jemaat/"
PATTERN_PREFIX = "https://www.gkiharapanindah.org/nyanyian-jemaat/pelengkap-kidung-jemaat/pkj"
...
FALLBACK_ENDPOINTS = [
    ...
    "https://www.gkiharapanindah.org/category/nyanyian-jemaat/pelengkap-kidung-jemaat/",
    "https://www.gkiharapanindah.org/category/nyanyian-jemaat/pelengkap-kidung-jemaat/feed/",
]
...
def extract_matching_links_from_html(html: str, base_url: str = "") -> List[str]:
    ...
    rx = re.compile(r"https://www\.gkiharapanindah\.org/nyanyian-jemaat/pelengkap-kidung-jemaat/pkj[^\s\"'<)]+", re.I)
...
def main():
    ...
    with open("pkj_links.txt", "w", encoding="utf-8") as f:
        f.write("\n".join(links))
    with open("pkj_links.json", "w", encoding="utf-8") as f:
