...
COLUMN_TO_PROPERTY: Dict[str, Tuple[str, str]] = {
    "Tanggal": ("custom", "_TANGGAL"),
    "Nama Minggu": ("core", "subject"),
    "Warna Liturgi": ("custom", "_WARNA_LITURGI"),
    "Tema": ("core", "title"),
    "Bacaan 1": ("custom", "_BACAAN_1"),
    "Antar Bacaan": ("custom", "_ANTAR_BACAAN"),
    "Bacaan 2": ("custom", "_BACAAN_2"),
    "Bacaan Injil": ("custom", "_BACAAN_INJIL"),
    "Pelayan Firman": ("custom", "_PELAYAN_FIRMAN"),
    "Nyanyian Prosesi": ("custom", "_NYANYIAN_PROSESI"),
    "Nyanyian Pengakuan Dosa": ("custom", "_NYANYIAN_PENGAKUAN_DOSA"),
    "Nyanyian Berita Anugerah": ("custom", "_NYANYIAN_BERITA_ANUGERAH"),
    "Nyanyian Persembahan": ("custom", "_NYANYIAN_PERSEMBAHAN"),
